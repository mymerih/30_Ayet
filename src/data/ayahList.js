export const ayahList = [
  ...
  },
  {
    ...
    surah: "Ali Imran",
    ayahNumber: 104,
    image: "3_AliImran_104.png",
    audio: "3_AliImran_104.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Zilzal",
    ayahNumber: "7-8",
    image: "5_Zilzal_7-8.png",
    audio: "5_Zilzal_7-8.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Hujurat",
    ayahNumber: 11,
    image: "7_Hujurat_11.png",
    audio: "7_Hujurat_11.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Baqara",
    ayahNumber: 148,
    image: "8_Baqara_148.png",
    audio: "8_Baqara_148.mp3",
    arabicText: "فَاسْتَبِقُوا الْخَيْرَاتِ إ",
    transliteration: "Feste bigû'l hayrât.",
    translations: {
      turkish: "Hayırlı işlerde birbirinizle yarışın.",
      german: "So wetteifert miteinander in allem, was gut ist.",
    },
  },
  {
    id: 9,
    surah: "Ibrahim",
    ayahNumber: 7,
    image: "9_Ibrahim_7.png",
    audio: "9_Ibrahim_7.mp3",
    arabicText:
      "وَإِذْ تَأَذَّنَ رَبُّكُمْ لَئِن شَكَرْتُمْ لَأَزِيدَنَّكُمْ وَلَئِن كَفَرْتُمْ إِنَّ عَذَابِي لَشَدِيدٌ",
    transliteration: "Ve iz te'ezzen rabbukum le'in şekartum le'ezîdennekum...",
    translations: {
      turkish:
  ...
  },
  {
    ...
    surah: "Ankabut",
    ayahNumber: 45,
    image: "10_Ankabut_45.png",
    audio: "10_Ankabut_45.mp3",
    arabicText:
...

  {
    ...
    surah: "Fatir",
    ayahNumber: 28,
    image: "11_Fatir_28.png",
    audio: "11_Fatir_28.mp3",
    arabicText: "إِنَّمَا يَخْشَى اللَّهَ مِنْ عِبَادِهِ الْعُلَمَاءُ ۗ إ",
    transliteration: "İnnemâ yahşellâhe min ibâdihil ulemâ.",
    translations: {
      turkish: "Allah’tan, kulları içinde ancak ilim sahibi olanlar korkar.",
      german:
  ...
  },
  {
    ...
    surah: "Ali Imran",
    ayahNumber: 92,
    image: "12_AliImran_92.png",
    audio: "12_AliImran_92.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Asr",
    ayahNumber: "1-3",
    image: "13_Asr_1-3.png",
    audio: "13_Asr_1-3.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Muhammad",
    ayahNumber: 7,
    image: "14_Muhammad_7.png",
    audio: "14_Muhammad_7.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Insan",
    ayahNumber: 7,
    image: "15_Insan_7.png",
    audio: "15_Insan_7.mp3",
    arabicText:
  ...
  },
  {
    ...
    audio: "17_Sad_29.mp3",
    arabicText:
      "كِتَابٌ أَنزَلْنَاهُ إِلَيْكَ مُبَارَكٌ لِّيَدَّبَّرُوا آيَاتِهِ وَلِيَتَذَكَّرَ أُو۟لُوا۟ ٱلۡأَلۡبَٰبِ",
    transliteration:
  ...
  },
  {
    ...
    surah: "Nahl",
    ayahNumber: 78,
    image: "18_Nahl_78.png",
    audio: "18_Nahl_78.mp3",
    arabicText:
    ...
    translations: {
      ...
      german:
        "Gott hat euch aus den Schößen eurer Mütter hervorgebracht, als ihr von nichts wusstet. Er gab euch Gehör, Augen und Herzen, damit ihr euren Dank abstatten mögt.",
    },
  },
  {
    id: 19,
    surah: "Kehf",
    ayahNumber: "107-108",
    image: "19_Kehf_107_108.png",
    audio: "19_Kehf_107_108.mp3",
    arabicText:
      "إِنَّ ٱلَّذِينَ ءَامَنُواْ وَعَمِلُواْ ٱلصَّٰلِحَٰتِ كَانَتۡ لَهُمۡ جَنَّٰتُ ٱلۡفِرۡدَوۡسِ نُزُلًا (107) خَٰلِدِينَ فِيهَا لَا يَبۡغُونَ عَنۡهَا حِوَلٗا (108)",
    transliteration:
      "İnnellezîne âmenû ve amilussâlihâti kânet lehum cennâtul firdevsi nuzulâ hâlidîne fîhâ lâ yebğûne anhâ hivâlâ.",
    translations: {
      turkish:
  ...
  },
  {
    ...
    surah: "Baqara",
    ayahNumber: 153,
    image: "20_Baqara_153.png",
    audio: "20_Baqara_153.mp3",
    arabicText:
      "يَا أَيُّهَا ٱلَّذِينَ ءَامَنُواْ ٱسۡتَعِينُواْ بِٱلصَّبۡرِ وَٱلصَّلَوٰةِۚ إِنَّ ٱللَّهَ مَعَ ٱلصَّٰبِرِينَ",
    transliteration:
  ...
  },
  {
    ...
    surah: "Baqara",
    ayahNumber: 10,
    image: "21_Baqara_10.png",
    audio: "21_Baqara_10.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Kehf",
    ayahNumber: "23-24",
    image: "22_Kehf_23-24.png",
    audio: "22_Kehf_23-24.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Isra",
    ayahNumber: 23,
    image: "23_Isra_23.png",
    audio: "23_Isra_23.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Enfal",
    ayahNumber: 46,
    image: "24_Enfal_46.png",
    audio: "24_Enfal_46.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Isra",
    ayahNumber: 36,
    image: "25_Isra_36.png",
    audio: "25_Isra_36.mp3",
    arabicText:
...

  {
    ...
    surah: "Beled",
    ayahNumber: 17,
    image: "26_Beled_17.png",
    audio: "26_Beled_17.mp3",
    arabicText:
    ...
    translations: {
      turkish:
        "Elbette iman etmiş olmak ve karşılıklı sabır teşvik ve tavsiyesinde bulunmak, merhamet teşvik ve tavsiyesinde bulunmak gerekir.",
      german:
  ...
  },
  {
    ...
    surah: "Isra",
    ayahNumber: 18,
    image: "27_Isra_18.png",
    audio: "27_Isra_18.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Tegabun",
    ayahNumber: 9,
    image: "28_Tegâbun_9.png",
    audio: "28_Tegâbun_9.mp3",
    arabicText:
    ...
    translations: {
      ...
      german:
        "Wer auch immer an Gott glaubt und gut, rechtschaffen handelt, dessen böse Taten wird Er für sie auslöschen und sie eintreten lassen in Gärten, durch die Ströme fließen, in denen sie für immer verweilen werden. Das ist die höchste Glückseligkeit.",
    },
  },
  {
    id: 29,
    surah: "Araf",
    ayahNumber: 44,
    image: "29_Araf_44.png",
    audio: "29_Araf_44.mp3",
    arabicText:
  ...
  },
  {
    ...
    surah: "Maun",
    ayahNumber: "4-7",
    image: "30_Maun_4-7.png",
    audio: "30_Maun_4-7.mp3",
    arabicText:
